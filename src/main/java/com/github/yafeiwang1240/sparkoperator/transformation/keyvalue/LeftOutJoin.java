...
/**
 * 说明：spark算子，leftOuterJoin
 * 特点：连接
 * 执行：leftOuterJoin算子在executor端执行, 但是涉及rdd之间的交互
 * sql: leftOuterJoin
 * @author wangyafei
 */
public class LeftOutJoin implements Function {

    @Override
    public void function() {
        Random random = new Random(47);
        SparkConf sparkConf = new SparkConf().setAppName("leftOuterJoin");
        ...
        JavaPairRDD<String, Tuple2<Integer, Optional<Integer>>> newRdd = rdd1.leftOuterJoin(rdd2);
